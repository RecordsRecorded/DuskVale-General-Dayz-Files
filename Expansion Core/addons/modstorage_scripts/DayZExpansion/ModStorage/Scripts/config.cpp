...
//'now' is Fri Jul 03 20:28:55 2026 : 'file' last modified on Mon Mar 10 10:30:38 2025
////////////////////////////////////////////////////////////////////
...
class CfgMods
{
	class DZ_Expansion_ModStorage
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"DayZExpansion/ModStorage/Scripts/1_Core"};
			};
			class gameLibScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/ModStorage/Scripts/2_GameLib"};
			};
			class gameScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/ModStorage/Scripts/3_Game"};
			};
			class worldScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/ModStorage/Scripts/4_World"};
			};
			class missionScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/ModStorage/Scripts/5_Mission"};
			};
		};
	};
};
