...
//'now' is Fri Jul 03 20:29:01 2026 : 'file' last modified on Thu Mar 28 16:28:33 2024
////////////////////////////////////////////////////////////////////
...
class CfgVehicles
{
	...
	class ExpansionAdminChest: SeaChest
	{
		...
		attachments[] = {"Shoulder","Melee","Vest","Body","Hips","Legs","Back","Headgear","Mask","Eyewear","Gloves","Feet","Armband","LEHS","Dogtag"};
		class Cargo
		{
...
class CfgWeapons
{
	...
	class Expansion_LobotomyDartGun_Base: FNX45_Base
	{
		...
		magazines[] = {"Mag_Expansion_LobotomyDart"};
		chamberableFrom[] = {"Ammo_Expansion_LobotomyDart"};
		...
		class SemiAuto: Mode_SemiAuto
		{
			...
			soundSetShotExt[] = {{"Dartgun_Shot_SoundSet","Dartgun_Tail_SoundSet","Dartgun_InteriorTail_SoundSet"}};
			reloadTime = 0.086;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 100;
					healthLevels[] = {{1.0,{"DZ\weapons\nonlethal\dartgun\data\dartgun.rvmat"}},{0.7,{"DZ\weapons\nonlethal\dartgun\data\dartgun.rvmat"}},{0.5,{"DZ\weapons\nonlethal\dartgun\data\dartgun_damage.rvmat"}},{0.3,{"DZ\weapons\nonlethal\dartgun\data\dartgun_damage.rvmat"}},{0.0,{"DZ\weapons\nonlethal\dartgun\data\dartgun_destruct.rvmat"}}};
				};
			};
		};
		class AnimEvents
...
class CfgMagazines
{
	...
	class Mag_Expansion_LobotomyDart: Mag_FNX45_15Rnd
	{
		...
		ammoItems[] = {"Ammo_Expansion_LobotomyDart"};
		tracersEvery = 0;
		mass = 10;
		class DamageSystem
		{
