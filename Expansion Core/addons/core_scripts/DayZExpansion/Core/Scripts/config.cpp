...
//'now' is Fri Jul 03 20:29:08 2026 : 'file' last modified on Fri Jul 03 11:46:39 2026
////////////////////////////////////////////////////////////////////
...
class CfgMods
{
	class DZ_Expansion_Core
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"DayZExpansion/Core/Scripts/Common","DayZExpansion/Core/Scripts/1_Core"};
			};
			class gameLibScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Core/Scripts/Common","DayZExpansion/Core/Scripts/2_GameLib"};
			};
			class gameScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Core/Scripts/Common","DayZExpansion/Core/Scripts/3_Game"};
			};
			class worldScriptModule
			{
				value = "";
				files[] = {"DayZExpansion/Core/Scripts/Common","DayZExpansion/Core/Scripts/4_World"};
			};
