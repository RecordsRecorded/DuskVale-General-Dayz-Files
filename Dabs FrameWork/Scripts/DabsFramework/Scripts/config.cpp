...
//'now' is Fri Jul 03 20:25:14 2026 : 'file' last modified on Sat May 30 16:53:36 2026
////////////////////////////////////////////////////////////////////
...
class CfgMods
{
	class DabsFramework
	{
		...
		class defs
		{
			class imageSets
			{
				files[] = {"DabsFramework/gui/imagesets/prefabs.imageset","DabsFramework/gui/icons/brands.imageset","DabsFramework/gui/icons/light.imageset","DabsFramework/gui/icons/regular.imageset","DabsFramework/gui/icons/solid.imageset","DabsFramework/gui/icons/thin.imageset"};
			};
			class widgetStyles
			{
