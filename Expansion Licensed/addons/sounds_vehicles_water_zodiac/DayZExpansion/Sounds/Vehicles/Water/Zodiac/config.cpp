...
//'now' is Fri Jul 03 20:30:49 2026 : 'file' last modified on Fri Sep 23 14:51:51 2022
////////////////////////////////////////////////////////////////////
...
class CfgSoundShaders
{
	...
	{
		samples[] = {{"DayZExpansion\Sounds\Vehicles\Water\Zodiac\Expansion_Zodiac_Engine_Ext",1}};
	...
	{
		samples[] = {{"DayZExpansion\Sounds\Vehicles\Water\Zodiac\Expansion_Zodiac_Idle_Ext",1}};
		volume = "(engineOn * 0.4) + (engineOn * (rpm / 4))";
	};
};
class CfgSoundSets
{
	...
	{
		soundShaders[] = {"Expansion_Zodiac_Engine_Int_SoundShader"};
		volumeFactor = 0.12;
	};
	class Expansion_Zodiac_Idle_Ext_SoundSet: Expansion_Zodiac_Base_Ext_SoundSet
	{
		soundShaders[] = {"Expansion_Zodiac_Idle_Int_SoundShader"};
		volumeFactor = 0.12;
	};
};
